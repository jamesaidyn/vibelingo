          ...
          <div className="max-w-sm mx-auto md:max-w-none grid gap-12 md:grid-cols-3 md:gap-x-10 md:gap-y-10 items-start">
            ...
            <article data-aos="fade-up">
              ...
              <h3 className="h4 font-playfair-display mb-2">
                <a className="text-slate-800 hover:underline hover:decoration-blue-100" href="#0">Speak Like a Local</a>
              </h3>
            ...
            <article data-aos="fade-up" data-aos-delay="100">
              ...
              <h3 className="h4 font-playfair-display mb-2">
                <a className="text-slate-800 hover:underline hover:decoration-blue-100" href="#0">Create to Learn</a>
              </h3>
              <p className="text-lg text-slate-500">
            ...
            <article data-aos="fade-up" data-aos-delay="200">
              ...
              <h3 className="h4 font-playfair-display mb-2">
                <a className="text-slate-800 hover:underline hover:decoration-blue-100" href="#0">Community = Consistency</a>
              </h3>
              <p className="text-lg text-slate-500">
