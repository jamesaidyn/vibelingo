...
import FeaturesImage01 from '@/public/images/vibe/Speak_Like_a_Local.png'
import FeaturesImage02 from '@/public/images/vibe/Create_to_Learn.png'
import FeaturesImage03 from '@/public/images/vibe/Community_Consistency.png'
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-playfair-display text-slate-100">
              Learn English by creating, not cramming
            </h2>
          </div>
          ...
          <div className="max-w-sm mx-auto md:max-w-none grid gap-12 md:grid-cols-3 md:gap-x-10 md:gap-y-10 items-start">
            ...
            <article data-aos="fade-up">
              <a className="relative block group mt-8 mb-4" href="#0">
                ...
                <div className="overflow-hidden">
                  <Image className="w-full aspect-square object-cover group-hover:scale-105 transition duration-700 ease-out" src={FeaturesImage01} width={342} height={342} alt="Speak Naturally" />
                </div>
                <div className="w-16 h-16 absolute bg-linear-to-b from-crimson-500 to-crimson-600 rounded-full -top-8 left-8">
              ...
              <h3 className="h4 font-playfair-display mb-2">
                <a className="text-slate-800 hover:underline hover:decoration-crimson-100" href="#0">Speak Like a Local</a>
              </h3>
              <p className="text-lg text-slate-500">
                Our AI voice chats and weekly roleplays help you sound real — not robotic. Learn modern phrases, accents, and confidence.
              </p>
            </article>
            ...
            <article data-aos="fade-up" data-aos-delay="100">
              <a className="relative block group mt-8 mb-4" href="#0">
                <div className="absolute inset-0 pointer-events-none border-2 border-slate-500 opacity-20 translate-x-4 -translate-y-4 group-hover:translate-x-0 group-hover:translate-y-0 transition duration-300 ease-out -z-10" aria-hidden="true"></div>
                <div className="overflow-hidden">
                  <Image className="w-full aspect-square object-cover group-hover:scale-105 transition duration-700 ease-out" src={FeaturesImage02} width={342} height={342} alt="Create in English" />
                </div>
                <div className="w-16 h-16 absolute bg-linear-to-b from-crimson-500 to-crimson-600 rounded-full -top-8 left-8">
                  <svg className="w-16 h-16 fill-current" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <h3 className="h4 font-playfair-display mb-2">
                <a className="text-slate-800 hover:underline hover:decoration-crimson-100" href="#0">Create to Learn</a>
              </h3>
              <p className="text-lg text-slate-500">
                Instead of grammar worksheets, you’ll post reels, explain memes, and record voice notes — all in real English.
              </p>
            </article>
            ...
            <article data-aos="fade-up" data-aos-delay="200">
              <a className="relative block group mt-8 mb-4" href="#0">
                <div className="absolute inset-0 pointer-events-none border-2 border-slate-500 opacity-20 translate-x-4 -translate-y-4 group-hover:translate-x-0 group-hover:translate-y-0 transition duration-300 ease-out -z-10" aria-hidden="true"></div>
                <div className="overflow-hidden">
                  <Image className="w-full aspect-square object-cover group-hover:scale-105 transition duration-700 ease-out" src={FeaturesImage03} width={342} height={342} alt="WhatsApp community learning" />
                </div>
                <div className="w-16 h-16 absolute bg-linear-to-b from-crimson-500 to-crimson-600 rounded-full -top-8 left-8">
                  <svg className="w-16 h-16 fill-current" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <h3 className="h4 font-playfair-display mb-2">
                <a className="text-slate-800 hover:underline hover:decoration-crimson-100" href="#0">Community = Consistency</a>
              </h3>
              <p className="text-lg text-slate-500">
                Weekly WhatsApp tasks and group challenges keep you on track. You're never alone in your learning journey.
              </p>
            </article>
