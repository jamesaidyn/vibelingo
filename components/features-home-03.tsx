...
const t = {
  heading: {
    en: 'Learn English by creating, not cramming',
    es: 'Aprende inglés creando, no memorizando',
  },
  features: [
    {
      title: {
      ...
      desc: {
        en: 'Our AI voice chats and weekly roleplays help you sound real — not robotic. Learn modern phrases, accents, and confidence.',
        es: 'Nuestras conversaciones por voz con IA y juegos de rol semanales te ayudan a sonar natural, no robótico. Aprende frases modernas, acentos y confianza.',
      },
      img: FeaturesImage01,
      icon: (
    ...
    },
    {
      title: {
        en: 'Create to Learn',
        es: 'Crea para aprender',
      },
      desc: {
        en: 'Instead of grammar worksheets, you’ll post reels, explain memes, and record voice notes — all in real English.',
        es: 'En lugar de hojas de gramática, subirás reels, explicarás memes y grabarás notas de voz — todo en inglés real.',
      },
      img: FeaturesImage02,
      icon: (
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-playfair-display text-slate-100">{t.heading[language]}</h2>
          </div>
            ...
            {t.features.map((item, index) => (
              <article key={index} data-aos="fade-up" data-aos-delay={index * 100}>
                <a className="relative block group mt-8 mb-4" href="#0">
                  ...
                  <div className="w-16 h-16 absolute bg-gradient-to-b from-crimson-500 to-crimson-600 rounded-full -top-8 left-8">
                ...
                <h3 className="h4 font-playfair-display mb-2">
                  <a className="text-slate-800 hover:underline hover:decoration-crimson-100" href="#0">
                    {item.title[language]}
                  </a>
                </h3>
