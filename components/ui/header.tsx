        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex md:grow justify-between items-center w-full">
            ...
            <ul className="flex items-center space-x-4">
              ...
              <li>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-crimson-500 hover:text-crimson-600 transition duration-150">
              ...
              <li>
                <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-crimson-500 hover:text-crimson-600 transition duration-150">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              <li>
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-crimson-500 hover:text-crimson-600 transition duration-150">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
