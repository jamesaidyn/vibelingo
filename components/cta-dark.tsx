          ...
          <div className="relative max-w-3xl mx-auto text-center">
            ...
            <div className="relative">
              <h2 className="h2 font-playfair-display text-slate-100 mb-4">
                Real English. Real confidence. <span className="text-emerald-500">No textbooks needed.</span>
              </h2>
              <p className="text-xl text-slate-400 mb-8">
                Join our WhatsApp community and practice with voice notes, weekly tasks, and human-like AI feedback — all designed to make you speak naturally.
              </p>
              <div>
