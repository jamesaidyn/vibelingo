...
export default function SocialIcons({ className = '' }: { className?: string }) {
 ...
 <a href="https://instagram.com" className="text-crimson-500 hover:text-crimson-600 transition duration-150 ease-in-out" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
 ...
 <a href="https://tiktok.com"  className="text-crimson-500 hover:text-crimson-600 transition duration-150 ease-in-out" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
   <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
 ...
 <a href="https://youtube.com" className="text-crimson-500 hover:text-crimson-600 transition duration-150 ease-in-out"  target="_blank" rel="noopener noreferrer" aria-label="YouTube">
 <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
