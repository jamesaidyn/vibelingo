...
export default function SocialIcons({ className = '' }: { className?: string }) {
    ...
    const { instagramLink,tiktokLink, youtubeLink } = useSocial()
    
  return (
    <div className={`flex space-x-6 ${className}`}>
 <a href={instagramLink} className="text-crimson-500 hover:text-crimson-600 transition duration-150 ease-in-out" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
 ...
 <a href={tiktokLink}  className="text-crimson-500 hover:text-crimson-600 transition duration-150 ease-in-out" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
   <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
 ...
 <a href={youtubeLink} className="text-crimson-500 hover:text-crimson-600 transition duration-150 ease-in-out"  target="_blank" rel="noopener noreferrer" aria-label="YouTube">
 <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
