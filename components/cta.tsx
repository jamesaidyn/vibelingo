          ...
          <div className="relative max-w-3xl mx-auto text-center">
            ...
            <div className="relative">
              <h2 className="h2 font-playfair-display text-slate-800 mb-4">
                Say goodbye to boring grammar drills and <span className="text-emerald-500">start speaking real English</span>.
              </h2>
              <p className="text-xl text-slate-500 mb-8">
                Get weekly coaching, real conversation tasks, and AI-powered feedback — right from your phone. Learn modern English the fun, useful way.
              </p>
              <div>
                <Link className="btn text-white bg-blue-600 hover:bg-blue-700 group" href="/request-demo">
                  Start Free <span className="tracking-normal text-blue-300 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
                </Link>
              </div>
            </div>
